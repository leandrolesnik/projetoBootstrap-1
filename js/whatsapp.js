...
const whatsapp = () => {
   ...
   let mensagem = "send?phone=" + telefone + "&text=* Formulario Contato de cliente -->> %0A Nome: %0A " + nome + " %0A E-mail: %0A " + email + " %0A Idade: %0A " + idade + " %0A CPF: %0A " + cpf + " %0A Genero: %0A " + genero + " %0A Acompanhamento: %0A " + acompanhamento + " %0A Comorbidade: %0A " + comorbidade;
